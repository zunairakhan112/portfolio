  ...
  return (
    <div
      className={clsx(
        ...
        "bg-[radial-gradient(circle_at_top,_rgba(21,16,11,0.95),_transparent_45%),radial-gradient(circle_at_bottom,_rgba(11,36,26,0.75),_transparent_60%),linear-gradient(120deg,_rgba(11,11,15,0.92),_rgba(16,9,5,0.95))]"
      )}
    >
      <div className="pointer-events-none fixed inset-0 -z-40 mix-blend-screen backdrop-blur-xl sm:backdrop-blur-3xl" />
      <motion.div
        key={`${id}-aurora-a`}
        aria-hidden
        className={clsx(
          "pointer-events-none absolute rounded-full bg-[radial-gradient(circle,_rgba(255,140,66,0.55),_transparent_55%)]",
          "-left-1/3 -top-1/4",
          isMobile ? "h-[75vw] w-[75vw] blur-2xl" : "h-[60vw] w-[60vw] blur-3xl"
        )}
      ...
      <motion.div
        ...
        aria-hidden
        className={clsx(
          "pointer-events-none absolute rounded-full bg-[radial-gradient(circle,_rgba(139,195,74,0.5),_transparent_60%)]",
          "-right-1/4 top-1/3",
          isMobile ? "h-[60vw] w-[60vw] blur-[120px]" : "h-[55vw] w-[55vw] blur-[180px]"
        )}
      ...
      <motion.div
        ...
        aria-hidden
        className={clsx(
          "pointer-events-none absolute -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(253,224,71,0.4),_transparent_65%)]",
          "left-1/2",
          isMobile ? "bottom-[-30vw] h-[82vw] w-[82vw] blur-[150px]" : "bottom-[-25vw] h-[70vw] w-[70vw] blur-[200px]"
        )}
        animate={{ rotate: [0, -30, 20], scale: [1, 1.25, 0.9] }}
        transition={{ duration: 30, repeat: Infinity, ease: [0.45, 0.05, 0.55, 0.95] }}
      />
      {!isMobile && <GoldenCracksOverlay gradientId={`${id}-crack-gradient`} />}
