        ...
        {section.capabilities.map((capability, index) => {
          ...
          return (
            <motion.div
              ...
              className="capability-card group relative overflow-hidden rounded-3xl border border-white/12 bg-white/[0.045] p-8 shadow-[0_28px_60px_rgba(9,14,17,0.22)] backdrop-blur-[28px]"
              variants={itemVariants}
              whileHover={{ y: -6 }}
            >
              <div
                className={`absolute inset-0 -z-10 bg-gradient-to-br ${gradient} opacity-75 transition-opacity duration-500 group-hover:opacity-100`}
              />
              <div className="flex items-start justify-between gap-4">
                ...
                <motion.span
                  className="font-creative text-[0.7rem] uppercase tracking-[0.4em] text-foreground/40"
